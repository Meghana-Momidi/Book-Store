          ...
          <div className="rounded-t mb-0 px-4 py-3 border-0">
            <div className="flex flex-wrap items-center">
              <div className="relative w-full px-4 max-w-full flex-grow flex-1">
                <h3
                  className="font-semibold text-base text-blueGray-700 text-xl"
                  id="table-title"
                >
                  All Books
                </h3>
                ...
                {books &&
                  ...
                  filteredBooks.map((book, index) => (
                    <tr key={book._id}>
                      ...
                      <td
                        className="border-t-0 px-6 align-middle border-l-0 border-r-0 whitespace-nowrap p-4"
                        headers="col-1"
                      >
                        {book.title}
                      </td>
                      <td
                        className="border-t-0 px-6 align-center border-l-0 border-r-0 whitespace-nowrap p-4"
                        headers="col-2"
                      >
                        {book.category}
                      </td>
                      ...
                      <td
                        className="border-t-0 px-6 align-middle border-l-0 border-r-0 whitespace-nowrap p-4 space-x-4"
                        headers="col-4"
                      >
                        <Link
                          to={`/dashboard/edit-book/${book._id}`}
                          className="inline-block font-medium py-1 px-4 rounded-full text-white mr-2 dark:font-bold bg-gradient-to-r from-blue-400 via-blue-500 to-indigo-500 transform transition-all duration-200 hover:scale-110"
