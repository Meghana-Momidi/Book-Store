    ...
    <>
      <section className="flex md:bg-gray-200 min-h-screen overflow-hidden">
        <aside className="hidden sm:flex sm:flex-col bg-white md:w-20 lg:w-60 dark:bg-gray-900">
          ...
          {/* <h2 className="border-y py-3 text-gray-600 w-full text-center uppercase">menu</h2> */}
          <div className="flex-grow flex flex-col justify-between text-gray-500 ">
            <nav className="flex flex-col mx-4 my-6 space-y-4 text-center">
              <Link
                to="/dashboard"
                className="flex items-center justify-center lg:justify-start py-3 lg:pl-3 text-black hover:text-blue-600 rounded-lg transform hover:scale-110 transition duration-300 hover:bg-blue-100 w-full dark:text-gray-400"
              >
                <svg
                  aria-hidden="true"
                  fill="none"
                ...
                <span className="hidden lg:flex pl-4">Dashboard</span>
              </Link>
              <Link
              ...
              >
                ...
                <span className="hidden lg:flex pl-4">Add Book</span>
              </Link>
              <a
                href="#"
                className="flex items-center justify-center lg:justify-start py-3 lg:pl-3 text-black hover:text-blue-600 rounded-lg transform hover:scale-110 transition duration-300 hover:bg-blue-100 w-full dark:text-gray-400"
              >
                ...
                <span className="hidden lg:flex pl-4">Manage</span>
              </a>
            </nav>
          </div>
        </aside>
