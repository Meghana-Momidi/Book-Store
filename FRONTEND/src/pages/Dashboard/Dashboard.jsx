  ...
  return (
    <>
      ...
      <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
        <div className="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg dark:bg-gray-800">
        ...
        <div className="flex items-center p-8 bg-white shadow rounded-lg dark:bg-gray-800">
          ...
          <div>
            <span className="block text-2xl font-bold dark:text-gray-300">
              02
            </span>
